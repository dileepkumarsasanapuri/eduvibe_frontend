...
const CourseDescription = ({user}) => {
    ...
    const checkoutHandler = async() =>{
        ...
        const  {data:{order}}=await axios.post(`${server}/api/course/checkout/${params.id}`,{},{headers:{
            token,
        },});
        ...
        const options ={
             ...
             currency: "INR",
              name: "EduVIBE", //your business name
   ...
   <>
   {
    loading ? (<Loading/>):(
        ...
        { course && <div className="course-description">
            ...
            <p>Let's Dive Into The Course At ₹ {course.price}</p>
